...
//        return $query;
        $query = $this->select()
                ->from(array("u" => "Exampleuser"), array("user_id", "user_name"))
                ->where("u.user_id", "=", 11)
    ...
    public function getUserByUsername($username) {
        $query = $this->select()
                ->from(array("u" => "Exampleuser"), array("user_id", "user_password", "user_status","user_avatar","user_username"))
    ...
    public function getUserById($user_id) {
        $query = $this->select()
                ->from(array("Exampleuser"), array("user_id", "user_name", "user_surname", "user_avatar", "user_gender", "user_username", "user_email", "user_birthdate", "user_creation_date", "user_last_login", "user_status", "user_newsletter"))
    ...
    function isEmailExists($email) {
        $query = $this->select()
                ->from(array("Exampleuser"), array("user_id", "user_email"))
    ...
    function isUsernameExists($username) {
        $query = $this->select()
                ->from(array("u" => "Exampleuser"), array("user_id", "user_username"))
    ...
    //Retourne le nom d'un Exampleuser par son ID
    ...
    public function getNewsletter() {
            $query = $this->select()
                    ->from(array("u" =>"Exampleuser"), array("user_id, user_email, user_surname"))
    ...
    public function serieUser($user_id) {
            $query = $this->select()
                    ->from(array("u" =>"Exampleuser", "s" => "serie"))
